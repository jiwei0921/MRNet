...
parser.add_argument('--train_dataroot', default='./DiscRegion',
                    type=str, help='path to train data')
parser.add_argument('--test_dataroot', default='./DiscRegion',
                    type=str, help='path to test or val data')
...
train_sub = MyData(args.train_dataroot, DF=['BinRushed','MESSIDOR'],transform=True, augment=True)
